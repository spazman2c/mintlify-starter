...
| Multi add-on | Unlocks multi-agent and multi-channel workflows for lower tiers. |
...
- Customer-paid model usage through the connected OpenAI, Anthropic, or Google
  account.
...
Woes uses Stripe as the billing source of truth.
