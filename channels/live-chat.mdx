...
<Steps>
  ...
  <Step title="Install the snippet">
    Copy the current snippet from **Settings → Install** or **Settings → Keys**. For Mintlify docs sites, use [Install the Widget in Mintlify](/quickstart/install-widget-mintlify).
  </Step>
